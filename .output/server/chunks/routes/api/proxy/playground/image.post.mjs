import { d as defineEventHandler, c as getRequestLocale, aM as getUserSession, e as createError, r as readBody, ca as getAIGatewayUrl } from '../../../../nitro/nitro.mjs';
import 'drizzle-orm';
import 'crypto';
import 'fs';
import 'path';
...
const image_post = defineEventHandler(async (event) => {
  ...
  const payload = { model, prompt, n: Math.min(Math.max(Number(n) || 1, 1), 4) };
