...
import { C as useRoute, b8 as useActiveTheme, bE as themeLayoutLoaders } from './server.mjs';
  ...
  setup(__props) {
    ...
    const activeLayout = computed(() => {
      return defineAsyncComponent(() => {
        if (!activeTheme.value) return import('./default-MF8hf1b1.mjs');
        const loadThemeLayout = themeLayoutLoaders[activeTheme.value];
        if (!loadThemeLayout) {
          return import('./default-MF8hf1b1.mjs');
        }
