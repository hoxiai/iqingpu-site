...
import __nuxt_component_2 from './ShoplyConsultDialog-DKjjTpck.mjs';
...
import { u as useShoplyConsult } from './useShoplyConsult-DIlKr7yf.mjs';
import { useRouter } from 'vue-router';
import { r as ru, e as en, a as zhHK, z as zh } from './zh-HK-DaLlJjLw.mjs';
...
import 'unhead/utils';
import './ShoplyLeadForm-NKKoCaiK.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const copy = computed(() => (localeMessages[locale.value] || zh).pages.pricing);
    ...
    useSeoMeta({
      ...
      keywords: () => copy.value.seoKeywords,
