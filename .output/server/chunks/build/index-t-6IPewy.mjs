...
import { s as shoplyBindLocales, _ as __nuxt_component_6 } from './ShoplyBindDialog-B1GFYYf-.mjs';
...
import { u as useShoplyConsoleCopy, i as isShoplyNotConfigured, r as readShoplyErrorReason, f as formatCopy } from './useShoplyConsole-CWTzuEoB.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const bindCopy = computed(() => {
      const code = locale.value in shoplyBindLocales ? locale.value : "zh";
    ...
    const defaultsForLocale = () => {
      const lang = isShoplyStoreLang(locale.value) ? locale.value : "zh";
