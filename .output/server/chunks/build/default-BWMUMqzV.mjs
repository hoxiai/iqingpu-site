import { _ as __nuxt_component_0 } from './EmailVerificationBanner-CEVRzDlH.mjs';
...
import { s as shoplyMarketplaceLocales } from './marketplace-1fbll1JN.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const marketplaceCopy = computed(() => shoplyMarketplaceLocales[locale.value in shoplyMarketplaceLocales ? locale.value : "en"]);
