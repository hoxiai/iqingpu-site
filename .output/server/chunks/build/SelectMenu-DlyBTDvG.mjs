...
import { ar as useLocale, as as useAppConfig, aC as useComponentUI, aj as useForwardPropsEmits, aD as reactivePick, at as usePortal, aH as useFormField, aI as useFieldGroup, aJ as useComponentIcons, au as createReusableTemplate, aE as tv, av as isArrayOfArray, aK as compare, ax as get, b as _sfc_main$G, aw as _sfc_main$E, aL as _sfc_main$F, k as _sfc_main$B, a0 as FocusScope_default, d as _sfc_main$k, al as useId, aq as usePrimitiveElement, Y as useForwardExpose, ab as Primitive, S as useDirection, V as useVModel, T as PopperRoot_default, aM as looseToNumber, P as PopperAnchor_default, aN as getDisplayValue, am as Teleport_default, ae as Presence_default, Q as PopperArrow_default, U as createContext, aG as createEventHook, X as useBodyScrollLock, W as useFocusGuards, ak as useHideOthers, ai as useForwardProps, a1 as DismissableLayer_default, a2 as PopperContent_default } from './server.mjs';
import { g as getEstimateSize, L as ListboxItem_default, a as ListboxItemIndicator_default, b as ListboxRoot_default, i as injectListboxRootContext, c as ListboxFilter_default, d as ListboxVirtualizer_default, e as ListboxGroup_default, f as ListboxContent_default } from './virtualizer-BDH8S4rt.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(ComboboxItem_default), {
              "data-slot": "item",
              class: ui.value.item({ class: (_a = unref(uiProp)) == null ? void 0 : _a.item }),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`<span data-slot="itemLabel" class="${ssrRenderClass(ui.value.itemLabel({ class: (_a2 = unref(uiProp)) == null ? void 0 : _a2.itemLabel }))}"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("span", {
                      "data-slot": "itemLabel",
                      class: ui.value.itemLabel({ class: (_b2 = unref(uiProp)) == null ? void 0 : _b2.itemLabel })
                    }, [
            ...
            return [
              createVNode(unref(ComboboxItem_default), {
                "data-slot": "item",
                class: ui.value.item({ class: (_b = unref(uiProp)) == null ? void 0 : _b.item }),
                value: searchTerm.value,
                onSelect: onCreate
              }, {
                default: withCtx(() => {
                  ...
                  return [
                    createVNode("span", {
                      "data-slot": "itemLabel",
                      class: ui.value.itemLabel({ class: (_a2 = unref(uiProp)) == null ? void 0 : _a2.itemLabel })
                    }, [
                      renderSlot(_ctx.$slots, "create-item-label", { item: searchTerm.value }, () => [
                        createTextVNode(toDisplayString(unref(t)("selectMenu.create", { label: searchTerm.value })), 1)
                      ])
          ...
          if (_push2) {
            if (isSelectItem(item) && item.type === "label") {
              _push2(ssrRenderComponent(unref(ComboboxLabel_default), {
                "data-slot": "label",
                class: ui.value.label({ class: [(_a = unref(uiProp)) == null ? void 0 : _a.label, (_b = item.ui) == null ? void 0 : _b.label, item.class] })
              }, {
              ...
              _push2(ssrRenderComponent(unref(ComboboxSeparator_default), {
                "data-slot": "separator",
                class: ui.value.separator({ class: [(_c = unref(uiProp)) == null ? void 0 : _c.separator, (_d = item.ui) == null ? void 0 : _d.separator, item.class] })
              }, null, _parent2, _scopeId));
            } else {
              _push2(ssrRenderComponent(unref(ComboboxItem_default), {
                "data-slot": "item",
                class: ui.value.item({ class: [(_e = unref(uiProp)) == null ? void 0 : _e.item, isSelectItem(item) && ((_f = item.ui) == null ? void 0 : _f.item), isSelectItem(item) && item.class] }),
                  ...
                  if (_push3) {
                    ssrRenderSlot(_ctx.$slots, "item", {
                      ...
                      if (isSelectItem(item) && (unref(get)(item, props.descriptionKey) || !!slots["item-description"])) {
                        _push3(`<span data-slot="itemDescription" class="${ssrRenderClass(ui.value.itemDescription({ class: [(_e2 = unref(uiProp)) == null ? void 0 : _e2.itemDescription, isSelectItem(item) && ((_f2 = item.ui) == null ? void 0 : _f2.itemDescription)] }))}"${_scopeId2}>`);
                      ...
                      _push3(`</span><span data-slot="itemTrailing" class="${ssrRenderClass(ui.value.itemTrailing({ class: [(_g2 = unref(uiProp)) == null ? void 0 : _g2.itemTrailing, isSelectItem(item) && ((_h2 = item.ui) == null ? void 0 : _h2.itemTrailing)] }))}"${_scopeId2}>`);
                      ...
                      renderSlot(_ctx.$slots, "item", {
                        ...
                        return [
                          ...
                          createVNode("span", {
                            ...
                            class: ui.value.itemWrapper({ class: [(_a2 = unref(uiProp)) == null ? void 0 : _a2.itemWrapper, isSelectItem(item) && ((_b2 = item.ui) == null ? void 0 : _b2.itemWrapper)] })
                          }, [
                            createVNode("span", {
                              "data-slot": "itemLabel",
                              class: ui.value.itemLabel({ class: [(_c2 = unref(uiProp)) == null ? void 0 : _c2.itemLabel, isSelectItem(item) && ((_d2 = item.ui) == null ? void 0 : _d2.itemLabel)] })
                            }, [
                            ...
                            isSelectItem(item) && (unref(get)(item, props.descriptionKey) || !!slots["item-description"]) ? (openBlock(), createBlock("span", {
                              ...
                              class: ui.value.itemDescription({ class: [(_e2 = unref(uiProp)) == null ? void 0 : _e2.itemDescription, isSelectItem(item) && ((_f2 = item.ui) == null ? void 0 : _f2.itemDescription)] })
                            }, [
                          ...
                          createVNode("span", {
                            ...
                            class: ui.value.itemTrailing({ class: [(_g2 = unref(uiProp)) == null ? void 0 : _g2.itemTrailing, isSelectItem(item) && ((_h2 = item.ui) == null ? void 0 : _h2.itemTrailing)] })
                          }, [
            ...
            return [
              isSelectItem(item) && item.type === "label" ? (openBlock(), createBlock(unref(ComboboxLabel_default), {
                key: 0,
                "data-slot": "label",
                class: ui.value.label({ class: [(_g = unref(uiProp)) == null ? void 0 : _g.label, (_h = item.ui) == null ? void 0 : _h.label, item.class] })
              }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(get)(item, props.labelKey)), 1)
                ]),
                ...
                key: 1,
                "data-slot": "separator",
                class: ui.value.separator({ class: [(_i = unref(uiProp)) == null ? void 0 : _i.separator, (_j = item.ui) == null ? void 0 : _j.separator, item.class] })
              }, null, 8, ["class"])) : (openBlock(), createBlock(unref(ComboboxItem_default), {
                key: 2,
                "data-slot": "item",
                class: ui.value.item({ class: [(_k = unref(uiProp)) == null ? void 0 : _k.item, isSelectItem(item) && ((_l = item.ui) == null ? void 0 : _l.item), isSelectItem(item) && item.class] }),
                disabled: isSelectItem(item) && item.disabled,
                value: props.valueKey && isSelectItem(item) ? unref(get)(item, props.valueKey) : item,
                onSelect: ($event) => onSelect($event, item)
              }, {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        if (unref(isLeading) || !!__props.avatar || !!slots.leading) {
                          _push4(`<span data-slot="leading" class="${ssrRenderClass(ui.value.leading({ class: (_a2 = unref(uiProp)) == null ? void 0 : _a2.leading }))}"${_scopeId3}>`);
                          ssrRenderSlot(_ctx.$slots, "leading", {
                            ...
                            if (unref(isLeading) && unref(leadingIconName)) {
                              ...
                              _push4(ssrRenderComponent(_sfc_main$E, mergeProps({
                                ...
                                "data-slot": "itemLeadingAvatar",
                                class: ui.value.itemLeadingAvatar({ class: (_c2 = unref(uiProp)) == null ? void 0 : _c2.itemLeadingAvatar })
                              }), null, _parent4, _scopeId3));
                            } else {
                              _push4(`<!---->`);
                            }
                        ...
                        ssrRenderSlot(_ctx.$slots, "default", {
                          ...
                          ssrRenderList([displayValue(modelValue)], (displayedModelValue) => {
                            ...
                            if (displayedModelValue !== void 0 && displayedModelValue !== null) {
                              _push4(`<span data-slot="value" class="${ssrRenderClass(ui.value.value({ class: (_a3 = unref(uiProp)) == null ? void 0 : _a3.value }))}"${_scopeId3}>${ssrInterpolate(displayedModelValue)}</span>`);
                            } else {
                              _push4(`<span data-slot="placeholder" class="${ssrRenderClass(ui.value.placeholder({ class: (_b3 = unref(uiProp)) == null ? void 0 : _b3.placeholder }))}"${_scopeId3}>${ssrInterpolate((_c2 = __props.placeholder) != null ? _c2 : "\xA0")}</span>`);
                            }
                            _push4(`<!--]-->`);
                          });
                          _push4(`<!--]-->`);
                        ...
                        if (unref(isTrailing) || !!slots.trailing || !!__props.clear) {
                          _push4(`<span data-slot="trailing" class="${ssrRenderClass(ui.value.trailing({ class: (_b2 = unref(uiProp)) == null ? void 0 : _b2.trailing }))}"${_scopeId3}>`);
                                ...
                                default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                                  ...
                                  if (_push5) {
                                    _push5(ssrRenderComponent(_sfc_main$B, mergeProps({
                                      ...
                                      class: ui.value.trailingClear({ class: (_a4 = unref(uiProp)) == null ? void 0 : _a4.trailingClear }),
                                      onClick: onClear
                                    ...
                                    return [
                                      createVNode(_sfc_main$B, mergeProps({
                                        ...
                                        "data-slot": "trailingClear",
                                        class: ui.value.trailingClear({ class: (_b3 = unref(uiProp)) == null ? void 0 : _b3.trailingClear }),
                        ...
                        return [
                          unref(isLeading) || !!__props.avatar || !!slots.leading ? (openBlock(), createBlock("span", {
                            key: 0,
                            "data-slot": "leading",
                            class: ui.value.leading({ class: (_c = unref(uiProp)) == null ? void 0 : _c.leading })
                          }, [
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList([displayValue(modelValue)], (displayedModelValue) => {
                              ...
                              return openBlock(), createBlock(Fragment, { key: displayedModelValue }, [
                                displayedModelValue !== void 0 && displayedModelValue !== null ? (openBlock(), createBlock("span", {
                                  key: 0,
                                  "data-slot": "value",
                                  class: ui.value.value({ class: (_a3 = unref(uiProp)) == null ? void 0 : _a3.value })
                                }, toDisplayString(displayedModelValue), 3)) : (openBlock(), createBlock("span", {
                                  key: 1,
                                  "data-slot": "placeholder",
                                  class: ui.value.placeholder({ class: (_b3 = unref(uiProp)) == null ? void 0 : _b3.placeholder })
                          ...
                          unref(isTrailing) || !!slots.trailing || !!__props.clear ? (openBlock(), createBlock("span", {
                            key: 1,
                            "data-slot": "trailing",
                            class: ui.value.trailing({ class: (_d = unref(uiProp)) == null ? void 0 : _d.trailing })
                          }, [
                      ...
                      default: withCtx(() => {
                        ...
                        return [
                          unref(isLeading) || !!__props.avatar || !!slots.leading ? (openBlock(), createBlock("span", {
                            key: 0,
                            "data-slot": "leading",
                            class: ui.value.leading({ class: (_a2 = unref(uiProp)) == null ? void 0 : _a2.leading })
                          }, [
                            renderSlot(_ctx.$slots, "leading", {
                              modelValue,
                              open,
                              ...
                              return [
                                unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$G, {
                                  ...
                                  "data-slot": "itemLeadingAvatar",
                                  class: ui.value.itemLeadingAvatar({ class: (_c = unref(uiProp)) == null ? void 0 : _c.itemLeadingAvatar })
                                }), null, 16, ["size", "class"])) : createCommentVNode("", true)
                              ];
                            })
                          ], 2)) : createCommentVNode("", true),
                          ...
                          unref(isTrailing) || !!slots.trailing || !!__props.clear ? (openBlock(), createBlock("span", {
                            key: 1,
                            "data-slot": "trailing",
                            class: ui.value.trailing({ class: (_b2 = unref(uiProp)) == null ? void 0 : _b2.trailing })
                          }, [
                            renderSlot(_ctx.$slots, "trailing", {
                              modelValue,
                              open,
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(ComboboxContent_default), mergeProps({
                    "data-slot": "content",
                    class: ui.value.content({ class: (_a = unref(uiProp)) == null ? void 0 : _a.content })
                  }, contentProps.value), {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      var _a2, _b2, _c, _d;
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(FocusScope_default), {
                          ...
                          class: ui.value.focusScope({ class: (_a2 = unref(uiProp)) == null ? void 0 : _a2.focusScope })
                        }, {
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                                  ...
                                  default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                    ...
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_sfc_main$k, mergeProps({
                                        ...
                                        "model-modifiers": {
                                          trim: (_a4 = __props.modelModifiers) == null ? void 0 : _a4.trim
                                        },
                                        "data-slot": "input",
                                        class: ui.value.input({ class: (_b4 = unref(uiProp)) == null ? void 0 : _b4.input }),
                                        onChange: () => {
                                        }
                                      ...
                                      return [
                                        createVNode(_sfc_main$k, mergeProps({
                                          ...
                                          "model-modifiers": {
                                            trim: (_c3 = __props.modelModifiers) == null ? void 0 : _c3.trim
                                          },
                                          "data-slot": "input",
                                          class: ui.value.input({ class: (_d3 = unref(uiProp)) == null ? void 0 : _d3.input }),
                              ...
                              _push5(ssrRenderComponent(unref(ComboboxEmpty_default), {
                                "data-slot": "empty",
                                class: ui.value.empty({ class: (_a3 = unref(uiProp)) == null ? void 0 : _a3.empty })
                              }, {
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                              ...
                              _push5(`<div role="presentation" data-slot="viewport" class="${ssrRenderClass(ui.value.viewport({ class: (_b3 = unref(uiProp)) == null ? void 0 : _b3.viewport }))}"${_scopeId4}>`);
                              if (!!__props.virtualize) {
                                ...
                                if (createItem.value && createItemPosition.value === "top") {
                                  _push5(ssrRenderComponent(unref(ComboboxGroup_default), {
                                    "data-slot": "group",
                                    class: ui.value.group({ class: (_c2 = unref(uiProp)) == null ? void 0 : _c2.group })
                                  }, {
                                    default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                ...
                                if (createItem.value && createItemPosition.value === "bottom") {
                                  _push5(ssrRenderComponent(unref(ComboboxGroup_default), {
                                    "data-slot": "group",
                                    class: ui.value.group({ class: (_d2 = unref(uiProp)) == null ? void 0 : _d2.group })
                                  }, {
                                    default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(unref(ReuseCreateItemTemplate), null, null, _parent6, _scopeId5));
                              ...
                              return [
                                ...
                                createVNode(unref(ComboboxEmpty_default), {
                                  "data-slot": "empty",
                                  class: ui.value.empty({ class: (_e = unref(uiProp)) == null ? void 0 : _e.empty })
                                }, {
                                  default: withCtx(() => [
                                    renderSlot(_ctx.$slots, "empty", { searchTerm: searchTerm.value }, () => [
                                      createTextVNode(toDisplayString(searchTerm.value ? unref(t)("selectMenu.noMatch", { searchTerm: searchTerm.value }) : unref(t)("selectMenu.noData")), 1)
                                ...
                                createVNode("div", {
                                  ...
                                  role: "presentation",
                                  "data-slot": "viewport",
                                  class: ui.value.viewport({ class: (_f = unref(uiProp)) == null ? void 0 : _f.viewport })
                                }, [
                                  !!__props.virtualize ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                    ...
                                    createItem.value && createItemPosition.value === "top" ? (openBlock(), createBlock(unref(ComboboxGroup_default), {
                                      key: 0,
                                      "data-slot": "group",
                                      class: ui.value.group({ class: (_g = unref(uiProp)) == null ? void 0 : _g.group })
                                    }, {
                                      default: withCtx(() => [
                                        createVNode(unref(ReuseCreateItemTemplate))
                                      ]),
                                    ...
                                    createItem.value && createItemPosition.value === "bottom" ? (openBlock(), createBlock(unref(ComboboxGroup_default), {
                                      key: 1,
                                      "data-slot": "group",
                                      class: ui.value.group({ class: (_h = unref(uiProp)) == null ? void 0 : _h.group })
                                    }, {
                                      default: withCtx(() => [
                                        createVNode(unref(ReuseCreateItemTemplate))
                                      ]),
                        ...
                        return [
                          createVNode(unref(FocusScope_default), {
                            trapped: "",
                            "data-slot": "focusScope",
                            class: ui.value.focusScope({ class: (_c = unref(uiProp)) == null ? void 0 : _c.focusScope })
                          }, {
                            default: withCtx(() => {
                              var _a3, _b3, _c2, _d2;
                              return [
                                ...
                                createVNode("div", {
                                  ...
                                  role: "presentation",
                                  "data-slot": "viewport",
                                  class: ui.value.viewport({ class: (_b3 = unref(uiProp)) == null ? void 0 : _b3.viewport })
                                }, [
                                  !!__props.virtualize ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                    createItem.value && createItemPosition.value === "top" ? (openBlock(), createBlock(unref(ReuseCreateItemTemplate), { key: 0 })) : createCommentVNode("", true),
                                    createVNode(unref(ComboboxVirtualizer_default), mergeProps({
                          ...
                          !!__props.arrow ? (openBlock(), createBlock(unref(ComboboxArrow_default), mergeProps({ key: 0 }, arrowProps.value, {
                            "data-slot": "arrow",
                            class: ui.value.arrow({ class: (_d = unref(uiProp)) == null ? void 0 : _d.arrow })
                                ...
                                createVNode("div", {
                                  ...
                                  !!__props.virtualize ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                    ...
                                    createItem.value && createItemPosition.value === "top" ? (openBlock(), createBlock(unref(ComboboxGroup_default), {
                                      key: 0,
                                      "data-slot": "group",
                                      class: ui.value.group({ class: (_c = unref(uiProp)) == null ? void 0 : _c.group })
                                    }, {
                                      default: withCtx(() => [
                                        createVNode(unref(ReuseCreateItemTemplate))
                                      ]),
                                    ...
                                    createItem.value && createItemPosition.value === "bottom" ? (openBlock(), createBlock(unref(ComboboxGroup_default), {
                                      key: 1,
                                      "data-slot": "group",
                                      class: ui.value.group({ class: (_d = unref(uiProp)) == null ? void 0 : _d.group })
                                    }, {
                                      default: withCtx(() => [
                                        createVNode(unref(ReuseCreateItemTemplate))
                                      ]),
                      ...
                      default: withCtx(() => {
                        ...
                        return [
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList([displayValue(modelValue)], (displayedModelValue) => {
                              ...
                              return openBlock(), createBlock(Fragment, { key: displayedModelValue }, [
                                displayedModelValue !== void 0 && displayedModelValue !== null ? (openBlock(), createBlock("span", {
                                  ...
                                  key: 1,
                                  "data-slot": "placeholder",
                                  class: ui.value.placeholder({ class: (_b2 = unref(uiProp)) == null ? void 0 : _b2.placeholder })
                                }, toDisplayString((_c = __props.placeholder) != null ? _c : "\xA0"), 3))
                              ], 64);
                            }), 128))
                          ]),
                          unref(isTrailing) || !!slots.trailing || !!__props.clear ? (openBlock(), createBlock("span", {
                            key: 1,
                            "data-slot": "trailing",
                            class: ui.value.trailing({ class: (_b = unref(uiProp)) == null ? void 0 : _b.trailing })
                          }, [
                            renderSlot(_ctx.$slots, "trailing", {
                              modelValue,
                              open,
                    ...
                    createVNode(unref(ComboboxContent_default), mergeProps({
                      ...
                      default: withCtx(() => {
                        ...
                        return [
                                  ...
                                  default: withCtx(() => {
                                    ...
                                    return [
                                      createVNode(_sfc_main$k, mergeProps({
                                        ...
                                        "data-slot": "input",
                                        class: ui.value.input({ class: (_b3 = unref(uiProp)) == null ? void 0 : _b3.input }),
                                        onChange: withModifiers(() => {
                                        }, ["stop"])
                                      }), null, 16, ["size", "model-modifiers", "class", "onChange"])
                                    ];
                          ...
                          !!__props.arrow ? (openBlock(), createBlock(unref(ComboboxArrow_default), mergeProps({ key: 0 }, arrowProps.value, {
                            "data-slot": "arrow",
                            class: ui.value.arrow({ class: (_b = unref(uiProp)) == null ? void 0 : _b.arrow })
                          }), null, 16, ["class"])) : createCommentVNode("", true)
                        ];
                      }),
                      _: 3
...
export { _sfc_main as _, useFilter as u };
