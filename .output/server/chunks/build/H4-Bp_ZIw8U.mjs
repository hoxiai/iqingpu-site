...
import { as as useAppConfig, aC as useComponentUI, bg as useRuntimeConfig, aE as tv } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a2, _b;
      return tv({ extend: tv(theme), ...((_b = (_a2 = appConfig.ui) == null ? void 0 : _a2.prose) == null ? void 0 : _b.h4) || {} })();
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.id && generate.value) {
        _push(`<a${ssrRenderAttr("href", `#${__props.id}`)} class="${ssrRenderClass(ui.value.link({ class: (_b = unref(uiProp)) == null ? void 0 : _b.link }))}">`);
