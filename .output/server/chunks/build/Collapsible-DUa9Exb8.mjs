...
import { ar as useLocale, as as useAppConfig, aC as useComponentUI, aE as tv, be as transformUI, b as _sfc_main$G, aj as useForwardPropsEmits, aD as reactivePick } from './server.mjs';
          ...
          if (_push2) {
            ...
            return [
              createVNode("button", {
                ...
                createVNode("span", {
                  class: ui.value.triggerLabel({ class: (_f = unref(uiProp)) == null ? void 0 : _f.triggerLabel })
