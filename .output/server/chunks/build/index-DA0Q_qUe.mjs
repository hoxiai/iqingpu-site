import { e as useI18n, aF as useLocaleRouter, t as useSettings, b9 as useSeoMeta, b as _sfc_main$G, a as __nuxt_component_3$1 } from './server.mjs';
...
import { e as en, z as zh, a as zhHK, r as ru } from './zh-HK-Du3iOIQl.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useSeoMeta({
      title: () => t("shoply.seo.title"),
      description: () => t("shoply.seo.description"),
      ogTitle: () => t("shoply.seo.title"),
      ogDescription: () => t("shoply.seo.description"),
      ogType: "website"
    });
