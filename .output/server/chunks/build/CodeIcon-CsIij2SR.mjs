...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const icons = computed(() => {
      var _a, _b;
      return defu(((_b = (_a = appConfig.ui) == null ? void 0 : _a.prose) == null ? void 0 : _b.codeIcon) || {}, theme);
    });
    const icon = computed(() => {
      var _a, _b;
      if (props.icon) {
      ...
      return (_b = name && icons.value[name.toLowerCase()]) != null ? _b : extension && ((_a = icons.value[extension]) != null ? _a : `i-vscode-icons-file-type-${extension}`);
    });
