...
import { aT as useNuxtApp, e as useI18n } from './server.mjs';

const adminLocaleModules = {
  zh: () => import('./admin-BAD8550K.mjs'),
  en: () => import('./admin-AmZJE5rz.mjs'),
  ru: () => import('./admin-CuoBknZ3.mjs'),
  "zh-HK": () => import('./admin-Ce-Xc0wK.mjs')
};
