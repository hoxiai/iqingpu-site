import __nuxt_component_0 from './MarketplaceDetail-FFrXRKX6.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const category = computed(() => entry.value ? copy.value.themeCategories[entry.value.category] || entry.value.category : "");
    ...
    useSeoMeta({
      ...
      description: () => {
        var _a;
        return ((_a = entry.value) == null ? void 0 : _a.summary) || copy.value.themes.seoDescription;
      },
      keywords: () => entry.value ? `${entry.value.name},${category.value},${copy.value.themes.seoKeywords}` : copy.value.themes.seoKeywords,
      ogTitle: () => {
        var _a;
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("themes/shoply/pages/theme/[slug].vue");
